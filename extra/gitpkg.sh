...
git_pc_sysinstall()
{
  if [ ! -d ${release}/pc-sysinstall ]; then
    ...
    git clone https://github.com/jonhermansen/pc-sysinstall.git ${release}/pc-sysinstall >/dev/null 2>&1
...
git_gbi()
{
  if [ ! -d ${release}/pc-sysinstall ]; then
   ...
   git clone https://github.com/jonhermansen/gbi.git ${release}/gbi >/dev/null 2>&1
